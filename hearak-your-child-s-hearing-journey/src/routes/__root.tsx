...
export const Route = createRootRouteWithContext<{ queryClient: QueryClient }>()({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Kokleyar implant olgan bolalar uchun raqamli reabilitatsiya yo'ldoshi." },
      { name: "author", content: "Hearak" },
      { property: "og:title", content: "Hearak" },
      { property: "og:description", content: "Sizning bolangizning eshitish va nutq sayohatidagi yumshoq yo'ldosh." },
