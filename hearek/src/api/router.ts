...
const routes: Route[] = [
  ...
  route("GET", "/api/admin/children/:id", handlers.adminChildDetail),
  route("POST","/api/admin/children/:id/assignments", handlers.adminAddAssignment),
  route("POST","/api/admin/children/:id/notes",       handlers.adminAddNote),
